...
function makeDiagram(selector) {
  ...
  diagram.xPosition = (floorNumber) => {
    if (floorNumber < 2)
      return 150 + (floorNumber * 600) / diagram.world.floors.length;
    else {
      return 150 + ((floorNumber - 2) * 600) / diagram.world.floors.length;
    }
  };
  diagram.yPosition = (floorNumber) => {
    if (floorNumber < 2) return 100;
    return 300;
  };
